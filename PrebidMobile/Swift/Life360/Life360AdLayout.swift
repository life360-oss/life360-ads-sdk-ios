...
/// Auto-layout work for the Life360Renderer
enum Life360AdLayout {
    ...
    /// Expands the banner and the DisplayView's first-child chain so a Life360 creative fills the
    ...
    @discardableResult
    static func applyLife360Expansion(
        displayView: UIView,
...
private let assertionMessageMainThread = "Life360AdLayout is Auto Layout work; expected the main thread"
