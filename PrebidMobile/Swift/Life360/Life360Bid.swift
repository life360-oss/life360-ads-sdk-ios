...
public class Life360Bid: Bid {
    ...
    // Always render as banner for Life360
    public override var adFormat: AdFormat? {
        return .banner
    }

    // Force plugin renderer selection to Life360
    public override var pluginRendererName: String? {
        return Life360RendererInternal.NAME
    }

    public override var pluginRendererVersion: String? {
        return Life360RendererInternal.VERSION
    }

    // Not used for rendering; return nil for Life360
