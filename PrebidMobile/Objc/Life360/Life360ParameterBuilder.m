...
@interface Life360ParameterBuilder ()
...
@implementation Life360ParameterBuilder
...
- (void)buildBidRequest:(nonnull PBMORTBBidRequest *)bidRequest {
    ...
    Life360ORTBDevice *device = [[Life360ORTBDevice alloc]
    ...
    // Life360 demand matches on the app bundle identifier, so always send it here —
