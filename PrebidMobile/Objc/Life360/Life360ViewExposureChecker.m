...
// Callback
@property (nonatomic, copy, nullable) Life360ExposureChangeHandler onExposureChange;
...
@implementation Life360ViewExposureChecker {
...
- (instancetype)initWithView:(UIView *)view onExposureChange:(Life360ExposureChangeHandler)onExposureChange {
...
- (void)setupScrollObserving {
    ...
    if (container && [self isActiveScrollView:container]) {
        ...
        __weak typeof(self) weakSelf = self;
        self.trackScrollDebounce = [Life360Utils debounceAction:^(id _Nullable param) {
            __strong typeof(weakSelf) self = weakSelf;
            if (!self) { return; }
...
- (BOOL)viewHasOpaqueVisualContent:(UIView *)view inBoundsRect:(CGRect)boundsRect {
    ...
    Class wkClass = [Life360ViewExposureChecker wkWebViewClass];
