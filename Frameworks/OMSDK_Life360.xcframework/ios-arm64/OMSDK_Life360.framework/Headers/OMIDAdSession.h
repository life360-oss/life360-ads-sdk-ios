 ...
 */
@interface OMIDLife360AdSession : NSObject

/**
 *  The AdSession configuration is used for check owners.
 */
@property(nonatomic, readonly) OMIDLife360AdSessionConfiguration *configuration;
/**
 ...
 */
- (nullable instancetype)initWithConfiguration:(OMIDLife360AdSessionConfiguration *)configuration
                              adSessionContext:(OMIDLife360AdSessionContext *)context
