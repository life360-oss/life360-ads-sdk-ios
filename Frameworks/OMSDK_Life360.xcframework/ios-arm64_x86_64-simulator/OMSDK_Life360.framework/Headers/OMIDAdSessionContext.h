 ...
 */
@interface OMIDLife360AdSessionContext : NSObject
 ...
 * @see OMIDSDK
 */
- (nullable instancetype)initWithPartner:(OMIDLife360Partner *)partner
...
- (nullable instancetype)initWithPartner:(OMIDLife360Partner *)partner
                               ...
                               resources:(NSArray<OMIDLife360VerificationScriptResource *> *)resources
                              contentUrl:(nullable NSString *)contentUrl
               customReferenceIdentifier:(nullable NSString *)customReferenceIdentifier
                                   error:(NSError *_Nullable *_Nullable)error;
...
- (nullable instancetype)initWithPartner:(OMIDLife360Partner *)partner
                              ...
                              contentUrl:(nullable NSString *)contentUrl
               customReferenceIdentifier:(nullable NSString *)customReferenceIdentifier
                           universalAdID:(nullable OMIDLife360UniversalAdID *)universalAdID
                                   error:(NSError *_Nullable *_Nullable)error;
