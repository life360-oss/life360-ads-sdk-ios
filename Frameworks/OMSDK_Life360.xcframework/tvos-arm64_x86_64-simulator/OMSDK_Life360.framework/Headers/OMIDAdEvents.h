 ...
 */
@interface OMIDLife360AdEvents : NSObject
 ...
 */
- (nullable instancetype)initWithAdSession:(nonnull OMIDLife360AdSession *)session error:(NSError * _Nullable * _Nullable)error;
 ...
 */
- (BOOL)loadedWithVastProperties:(OMIDLife360VASTProperties *_Nonnull)vastProperties
